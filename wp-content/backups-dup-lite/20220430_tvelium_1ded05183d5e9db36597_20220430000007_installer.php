...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220430_tvelium_1ded05183d5e9db36597_20220430000007_archive.zip';
	const ARCHIVE_SIZE		 = '42143809';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1ded051-30000007';
    const SECONDARY_PACKAGE_HASH = 'db6b786-30000007';
	const VERSION			 = '1.4.5';
