...
$key = "474955566a735f6539556a7738386a7349745d4f634b6a374e5c5a"; // 7b573454795867354d4857605b3778444e503739604863464c7771 
$merch_id = "161596709896"; //    193464634062
$order_items = '[' . $item_min .']';

$fields = array();
	
$fields["WMI_CURRENCY_ID"]        = "643";
$fields["WMI_DESCRIPTION"]        = "Оплата демонстрационного заказа";	
$fields["WMI_FAIL_URL"]           = "https://tvelium.ru/fail/";
$fields["WMI_SUCCESS_URL"]        = "https://tvelium.ru/success/";
$fields["WMI_MERCHANT_ID"]        = $merch_id;
$fields["WMI_PAYMENT_AMOUNT"]     = 0.5; // $sum
$fields["WMI_PAYMENT_NO"]         = $orderid;
$fields["WMI_ORDER_ITEMS"]        = $order_items;
$fields["WMI_PTENABLED"]          = ["CreditCardRUB","PsbRetailRUB","AlfaclickRUB","WalletOneRUB"]; //  "TestCardRUB"
