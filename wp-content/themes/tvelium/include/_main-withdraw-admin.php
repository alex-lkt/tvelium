        ...
        <div class="main-inner__content--wrapper box-noborder-nocolumn">
            <div class="content-help__box-left withdraw-box">
                ...
                <form class="help-chat" action="<?php echo esc_url(admin_url( 'admin-post.php' )) ?>" name="" method="POST" enctype="multipart/form-data">
                    <input type="text" name="help_title" class="help-edit__title-input" id="help-title" value="<?php echo $post_title ?>" placeholder="Введите желаемую сумму">
                    <textarea id="help-text" name="help_text" placeholder="Введите банковские реквизиты или номер карты для вывода денежных средств"></textarea>
