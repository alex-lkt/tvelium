    ...
    <div class="main-inner__content">
        ...
        <div class="main-inner__content--wrapper box-noborder-nocolumn">
            <div class="content-help__box-left">
                ...
                <form class="help-chat readsupport" action="" name="">
                    <input type="text" name="help_title" class="help-edit__title-input" id="help-title" value="<?php echo $post->post_title ?>">
                    <textarea id="help-text" name="help_text"><?php echo $post->post_content ?></textarea>
