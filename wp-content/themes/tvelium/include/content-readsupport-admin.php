...
//wp_vardump( $post->post_author );
//wp_vardump( $user->display_name );
?>
    ...
    <div class="main-inner__content">
        ...
        <div class="main-inner__content--wrapper box-noborder-nocolumn">
            <div class="content-help__box-left">
                ...
                <form class="help-chat readsupport" action="<?php echo esc_url(admin_url( 'admin-post.php' )) ?>" name="" method="POST" enctype="multipart/form-data">
                    <input type="text" name="help_title" class="help-edit__title-input" id="help-title" value="<?php echo $post->post_title ?>" placeholder="Тема">
                    <div class="content-help__text1">Вопрос:</div>
                    <textarea id="help-text" name="help_text" placeholder="Опишите проблему"><?php echo $post->post_content ?></textarea>
                    <div class="content-help__text1">Ответ:</div>
                    <textarea id="help-answer" name="help_answer"><?php echo get_post_meta( $post->ID, 'help_answer' )[0] ?></textarea>

                    <div class="content-help__text1"><?php echo $user->display_name ?></div>
                    <div class="content-help__data-box">
                        <div class="content-help__date"><?php echo the_time('j F Y'); ?></div>
                        <div class="content-help__status">
                            <?php
                    ...
                    <input type="hidden" name="help_status" value="executed">
            ...
            <div class="help-table__box">
                ...
                <?php
                    ...
                    foreach( $my_posts as $post ){
                        setup_postdata( $post );
                        $help_status = get_post_meta( $post->ID, 'help_status' );
                        $help_user = get_user_by( 'ID', $post->post_author );
                    ...
                    <tr class="help-table__text">
                        ...
                        <td><?php echo $help_user->display_name ?></td>
